...
echo openform('settingsform', 'post', FUSION_SELF.$aidlink, ['max_tokens' => 1]);
...
echo form_text('square_size', $locale['cvqr_1016'], $cvqr_settings['square_size'], ['type' => 'number', 'number_min' => 1, 'number_max' => 25, 'required' => TRUE]);
echo form_text('margin_size', $locale['cvqr_1017'], $cvqr_settings['margin_size'], ['type' => 'number', 'number_min' => 0, 'number_max' => 12, 'required' => TRUE]);
closeside();
...
echo form_select('corr_level', $locale['cvqr_1021'], $cvqr_settings['corr_level'], ['options' => $choice_arr, 'inline' => TRUE, 'required' => TRUE]);
closeside();

echo "</div>\n</div>";
echo form_button('savesettings', $locale['cvqr_1100'], $locale['cvqr_1100'], ['class' => 'btn-success']);
echo closeform();
closetable();
